        ...
        <div className='  flex flex-col-reverse md:flex-row  mt-[5rem] justify-center items-stretch'>
            <div className='flex flex-col justify-between px-4'>
               ...
               <p className="hidden md:block font-bold text-4xl  md:text-7xl leading-tight ">
                ...
                <p className=' text-gray-500 mt-9  leading-6 md:text-[1rem] w-[400px] '>Get your team in sync, no matter your location. Streamline processes,create team ritual, and watch productivity soar </p>
